    ...
    <el-card id="search">
      <el-row>
        <el-col :span="24">
          ...
          <el-input v-model="searchModal.sclass" placeholder="班级" clearable></el-input>
...
export default {
  ...
  methods: {
    ...
    getStuList() {
      stuApi.getSCList(this.searchModal).then(response => {
