    ...
    <el-dialog @close='clearForm' id="add" :title="title" :visible.sync="dialogAddVisible">
      <el-form :model="stuModal" ref='stuFromRef' :rules="rules">
        <el-form-item label="用户名" prop="username" :label-width="formLabelWidth">
          ...
          <el-input v-if="title == '修改成绩'" v-model="stuModal.username" autocomplete="off" disabled></el-input>
        </el-form-item>
        <el-form-item label="姓名" prop="name" :label-width="formLabelWidth">
          <el-input v-model="stuModal.name" autocomplete="off" disabled></el-input>
        </el-form-item>
        <el-form-item label="班级" :label-width="formLabelWidth">
          <el-select v-model="stuModal.classes" placeholder="请选择班级" disabled>
